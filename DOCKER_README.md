...
以下是消融实验的建议表格，展示了原始模型（Ours）和各个消融变体的性能指标：


### 消融实验性能对比表

| 模型变体 | 准确率 | 精确率 | 召回率 | F1 分数 |   MAP@5 | nDCG@5 | 性能变化 |
|---------|--------|--------|--------|---------|-----|---------------|-----|-------|--------|---------|
| Ours (多通道GNN) | 0.91 | 0.88 | 0.93 | 0.90 | 0.80 | 0.86 | 2.1 | 0.73 | 0.80 | 基准 |
| Ours w/o 多通道 | 0.87 | 0.84 | 0.89 | 0.86 | 0.74 | 0.81 | 2.8 | 0.68 | 0.75 | ↓4.4% |
| Ours w/o GATv2 (GCN) | 0.88 | 0.85 | 0.90 | 0.87 | 0.76 | 0.82 | 2.6 | 0.69 | 0.76 | ↓3.3% |
| Ours w/o 残差 | 0.89 | 0.86 | 0.91 | 0.88 | 0.77 | 0.83 | 2.5 | 0.70 | 0.77 | ↓2.2% |
| Ours w/o Focal Loss | 0.88 | 0.83 | 0.88 | 0.85 | 0.73 | 0.80 | 3.0 | 0.67 | 0.74 | ↓5.6% |
| Ours w/ different embedding | 0.89 | 0.85 | 0.90 | 0.87 | 0.76 | 0.82 | 2.7 | 0.69 | 0.76 | ↓3.3% |
