...
if __name__ == "__main__":
    ...
    # 写死的检查点路径
    best_path = "/home/wmy/linevd/storage/processed/raytune_baseline_-1/202604070632_2f49f45_规范实验/tune_linevd_baseline/train_linevd_7ea25_00000_0_batch_size=256,embtype=codebert,gamma=2,gatdropout=0.2000,gnntype=gat,gtype=pdg_raw,hdropout=0.3000,hfe_2026-04-07_06-32-29/checkpoint_000099"  # 替换为实际的检查点路径

    # 加载模型和数据模块 - 使用与baseline.py一致的参数
    model = lvd.LitGNN(
        hfeat=512,
        embtype="codebert",
        stmtweight=1,
    ...
    datamodule_args = {
        "batch_size": 256,  # 与baseline.py一致
        "nsampling_hops": 2,
        "gtype": "pdg+raw",  # 与baseline.py一致
        "splits": "default",  # 与baseline.py一致
    }
