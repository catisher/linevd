...
config = {
    ...
    "modeltype": tune.grid_search(["gat2layer", "gat2layer+residual"]),  # 对比有残差和无残差
...
# 设置保存路径
sp = svd.get_dir(svd.processed_dir() / f"raytune_myrq2_{samplesz}" / run_id)
